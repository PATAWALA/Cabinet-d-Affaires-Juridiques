  ...
  return (
    <section className="py-24 lg:py-32 px-4 bg-[#0B0F19]">
      <div className="max-w-6xl mx-auto space-y-16">
        ...
        {/* Texte narratif – aligné à gauche */}
        <div className="text-gray-300 text-lg leading-loose space-y-6 max-w-4xl mx-auto text-left">
          <p>
        ...
        {/* Chiffres marquants – centrés en grille */}
